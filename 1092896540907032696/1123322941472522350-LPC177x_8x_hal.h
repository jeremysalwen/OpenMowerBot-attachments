...
#define SENSOR_STUCK       (GPIO_TYPE(PORT_4, PIN_2, FUNC_0))
#define SENSOR_STUCK2      (GPIO_TYPE(PORT_2, PIN_21, FUNC_0))

#define SENSOR_DOOR        (GPIO_TYPE(PORT_1, PIN_25, FUNC_0))   //#define SENSOR_DOOR        (GPIO_TYPE(PORT_4, PIN_2, FUNC_0)) ->actually Stuck
...
#define SENSOR_DOOR2       (GPIO_TYPE(PORT_1, PIN_25, FUNC_0))  // #define SENSOR_DOOR2       (GPIO_TYPE(PORT_2, PIN_21, FUNC_0)) -->Stuck 2
